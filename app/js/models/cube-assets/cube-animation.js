export class CubeAnimation {
    ...
    renderPosition(move) {
        ...
        if (this.end) {
            ...
            console.log(s);
            if ((t.rotation.x === s.rotation.x && t.rotation.y === s.rotation.y && t.rotation.z === s.rotation.z) && (t.position.x === s.position.x && t.position.y === s.position.y && t.position.z === s.position.z)) {
                this.end = true
